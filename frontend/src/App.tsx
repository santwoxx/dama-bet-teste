...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-stone-100 flex flex-col font-sans select-none antialiased selection:bg-amber-500/30 selection:text-white relative">
      ...
      {/* Banner Topo (Só no Lobby) — estático, ocupando a largura inteira do site */}
      {currentView !== 'game' && (
        <div className="w-full mt-6">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="w-full h-auto shadow-[0_0_20px_rgba(250,191,24,0.3)] border-y border-[#FABF18]/30"
          />
        </div>
      )}
      ...
      {/* Banner Fim de Página — estático, ocupando a largura inteira do site */}
      {currentView !== 'game' && (
        <div className="w-full bg-[#0a0a0a]">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="w-full h-auto shadow-[0_0_15px_rgba(250,191,24,0.2)] border-y border-[#FABF18]/20"
          />
        </div>
      )}
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-[100] flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-3 sm:px-4 py-2 sm:py-3 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all hover:scale-105 hover:-translate-y-1 group border border-white/20"
      >
